...
### Inferential Results
My hopethsis is that more people that own a gun belive in death penalty rather then people that dont own a gun out of the stats they gave us. 
...
### Inferential Results
The hypothesis is it does not show enough evidence to know if people that belive in postlife also believe in the big bang theory.
...
#### Numerical Descriptive Results
79.31 do favorthat are white and 65.38 that are black oppose. 
<!--Numerical results go here. Use the numerical results to describe the patterns if any that exist in the data as focused toward the research question!-->
```{r}
...
### Inferential Results
My hypothesis would be white race believe in death penality thew most and black does oppose the most. 
